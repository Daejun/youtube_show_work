...
| Tags | SNIA, Storage Networking Industry Association, storage, standards, technologies, educational |
...
> 
> Presented by Simon Lund | Samsung - Principal Engineer
> 
> Learn More: 
> • SDC: StorageAI Website: https://www.snia.org/sniadeveloper/storageai 
> • SNIA Website: https://snia.org/ 
> • SNIA Educational Library: https://snia.org/library 
> • X: https://twitter.com/SNIA 
> • LinkedIn: https://linkedin.com/company/snia/
...
AiSIO, ACIO, NVMe, GPU, accelerator, storage, I/O orchestration, peer-to-peer DMA, device initiated IO, CPU initiated IO, SPDK, HOMIE daemon, Samsung, SNIA SDC, open source, Linux kernel, file system, IOPS, bandwidth, Ublock, DMA buff, F_MAP_AP, EBPF, PCIe Gen 5, SIOV, extend access library, StorageAI 2026, data loader, XME Perf, XNME, UPC, UPCE
...
### Products / works
- AiSIO (ACIO) [00:09]
- Nvidia GDS (GPU Direct Storage) [03:45]
- BAM (Big Accelerator Memory) [03:54]
- Nvidia Scattera [04:03]
- AMD ROCk XIO [04:08]
- SPDK [17:29]
- BDEV Perf [17:32]
- NVME Perf [18:59]
...
### Places
- Samsung Memory Research Center [17:12]

## Numbers and data points

| Value | Context | Time |
|---|---|---|
| 3.8 million | IOPS per NVMe drive in unallocated mode | 17:05 |
| 62 million | aggregate IOPS from 16 NVMe drives with 8 CPU cores (SPDK BDEV Perf baseline) | 17:35 |
| 7.7 million | IOPS per CPU core at baseline (linear scaling) | 17:46 |
| 16 | number of NVMe drives in the test system | 16:40 |
| 8 | CPU cores needed to saturate 16 NVMe drives at baseline | 17:35 |
| 6.3 million | IOPS with BDEV Perf, single hardware thread | 18:42 |
| 7.4 million | IOPS with BDEV Perf, two hardware threads | 18:47 |
| 16 million | IOPS with BDEV Perf, three hardware threads on two CPU cores | 18:50 |
| 32 million | IOPS with XME Perf, three hardware threads (application-layer tweaking) | 19:39 |
| 40 million | approximate IOPS with driver-layer tweaking, single hardware thread | 19:55 |
| 50 million | approximate IOPS with driver-layer tweaking, single CPU two hardware threads | 20:03 |
| 1.5 | CPU cores equivalent after optimization to reach 62 million IOPS | 20:57 |
| 3 | number of NVMe drives needed to saturate PCIe Gen 5 GPU link at 4K IO size | 24:02 |
| 4K | IO size at which three NVMe drives saturate PCIe Gen 5 GPU bandwidth | 24:02 |
| 8 | GPUs a single CPU can saturate in bandwidth at 4K IO size | 25:09 |
| 8 gigabyte | size of large pre-allocated files used in data-loader benchmark | 28:21 |
| 1774 seconds | video duration (~29 minutes 34 seconds) | not stated in transcript |
...
**Quotes**
> That's the control plane that sits at the host. It brings up everything and make sure that you have the multiple IO paths available.
> — unknown [08:41]
